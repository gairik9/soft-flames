...
export const PRODUCT_CONTENT = [
  {
    title: "Amber Dusk",
    description:
      "This warm blend of amber, sandalwood, and vanilla fills your space with a cozy twilight glow. Perfect for slow evenings, soft jazz, and winding down.",
    image: "/p1.jpg",
  ...
  },
  {
    ...
    description:
      "Inspired by nature’s calm — this earthy candle blends cedarwood, pine, and fresh moss. Best lit when you need grounding energy and rustic comfort.",
    image: "p2.jpg",
  ...
  },
  {
    title: "Citrus Bloom",
    description:
      "With notes of lemon zest, orange blossom, and a splash of bergamot, this candle brightens up your space — and your mood — in seconds.",
    image: "p3.jpg",
    alt: "Living Room Renovation",
  },
  {
    title: "Smoked Vanilla Ember",
    description:
      "A sultry, comforting scent with smoked vanilla, soft musk, and toasted wood. This is your go-to candle for date nights, book reading, or fireplace daydreaming.",
    image: "p4.jpg",
    alt: "Living Room Renovation",
  },
  {
    ...
    description:
      "Not your typical rose candle. Dark rose petals, oud wood, and black pepper create a luxurious and mysterious atmosphere — ideal for mood lighting with attitude.",
    image: "p5.jpg",
    alt: "Living Room Renovation",
  },
  {
    title: "Sea Salt Linen",
    description:
      "Evokes beach house mornings — crisp air, sea breeze, and fresh laundry. A clean-burning candle for minimalist souls and breezy Sundays.",
    image: "p6.jpg",
    alt: "Living Room Renovation",
  },
];
